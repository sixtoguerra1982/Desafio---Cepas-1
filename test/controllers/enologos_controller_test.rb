...
class EnologosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enologo" do
    assert_difference('Enologo.count') do
      post enologos_url, params: { enologo: { edad: @enologo.edad, nacionalidad: @enologo.nacionalidad, name: @enologo.name } }
    end
  ...
  test "should update enologo" do
    patch enologo_url(@enologo), params: { enologo: { edad: @enologo.edad, nacionalidad: @enologo.nacionalidad, name: @enologo.name } }
